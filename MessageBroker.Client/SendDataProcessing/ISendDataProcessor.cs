...
namespace MessageBroker.Client.SendDataProcessing
{
    ...
    {
        /// <summary>
        /// Will send data to server and wait for response based on <see cref="completeOnSeverOkReceived"/> 
        /// </summary>
        ...
        Task<SendAsyncResult> SendAsync(SerializedPayload serializedPayload, bool completeOnSeverOkReceived, CancellationToken cancellationToken);
    }
}